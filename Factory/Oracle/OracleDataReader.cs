...
{
    public class OracleDataReader : IDataReader, IDataRecord, IDisposable
    {
        IDataReader _reader;

        public OracleDataReader(IDataReader reader)
        {
            this._reader = reader;
        }
        ...
        public bool GetBoolean(int i)
        {
            ...
            else if (fieldType == UtilConstants.TypeOfDecimal)
                return Convert.ToBoolean(this._reader.GetDecimal(i));
            else return this._reader.GetBoolean(i);
        }
